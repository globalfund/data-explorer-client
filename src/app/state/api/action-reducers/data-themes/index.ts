...
export const DataThemeGet: ApiCallModel = {
  ...APIModel(`${process.env.REACT_APP_API_DX}/data-themes`),
};
...
export const DataThemeDuplicate: ApiCallModel = {
  ...APIModel(`${process.env.REACT_APP_API_DX}/data-themes/duplicate`),
};

export const DataThemeGetList: ApiCallModel = {
  ...APIModel(`${process.env.REACT_APP_API_DX}/data-themes-with-viz-count`),
};
