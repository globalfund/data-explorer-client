...
import { tableToolBoxData } from "./data";

interface StatisticalTableProps {
  columns: { [key: string]: string }[];
  tableData: { [key: string]: number | string | null }[];
  setTableData: React.Dispatch<
    React.SetStateAction<{ [key: string]: number | string | null }[]>
  >;
...
export default function StatisticalTable(props: StatisticalTableProps) {
